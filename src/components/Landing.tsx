...
const features = [
  {
    icon: Upload,
    title: "DNA Sequence Upload",
    desc: "Drag-and-drop FASTA, TXT, or paste raw sequences. Instant parsing with base-level validation.",
  },
  {
    icon: Binary,
    title: "Quantum Encoding",
    desc: "FRQI amplitude encoding maps nucleotide intensities into quantum states.",
  },
  {
    icon: LineChart,
    title: "Alignment Analytics",
    desc: "Real-time similarity, gap %, mismatch heatmaps and mutation scoring.",
  },
  {
    icon: Dna,
    title: "3D Visualization",
    desc: "Interactive double-helix viewer with base coloring and mutation highlighting.",
  },
  {
    icon: BrainCircuit,
    title: "AI Assisted Analysis",
    desc: "Genomic assistant summarizes alignments and surfaces meaningful variants.",
  },
  {
    icon: Gauge,
    title: "High Performance Simulation",
    desc: "Optimized qiskit-style simulator with Grover speedup benchmarks.",
  },
];
    ...
    <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 pt-6 pb-24 lg:grid-cols-[1.05fr_1fr] lg:pt-10">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="mt-6 max-w-xl text-lg text-muted-foreground">
              Accelerating genomic analysis using Quantum Computing, FRQI Encoding, and Grover
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="mt-4 text-muted-foreground">
              Every step of the pipeline — from raw FASTA upload to Grover-accelerated alignment —
      ...
      <section id="pipeline" className="relative z-10 py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            From nucleotide to <span className="text-gradient-emerald">quantum insight</span> in
            seconds.
          </motion.h2>
            ...
            <div className="relative grid gap-6 lg:grid-cols-[1.5fr_1fr] lg:items-center">
              <div>
                ...
                <h3 className="font-display text-3xl font-semibold sm:text-4xl">
                  Grover-accelerated sequence matching, benchmarked.
                </h3>
                <p className="mt-4 max-w-2xl text-muted-foreground">
                  Read our whitepaper on quadratic speedup for pattern search in genomic databases
                  using FRQI-encoded oracles.
                </p>
              </div>
      ...
      <footer className="relative z-10 border-t border-white/5 py-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-2">
            <Atom className="h-3.5 w-3.5 text-emerald" /> 12-qubit simulator
          </div>
        </div>
      </footer>
    </div>
